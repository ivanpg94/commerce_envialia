...
namespace Drupal\commerce_envialia\Plugin\Commerce\Condition;
 ...
 *
 * @CommerceCondition(
 *   id = "shipment_weight_multiple_conds_envialia",
 *   label = @Translation("Shipment weight - Multiple Conditions Envialia"),
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    for ($i = 1; $i <= 10; $i++) {
      ...
      $form['condition_' . $i]['price'] = [
        ...
        '#states' => [
          'invisible' => [
            ':input[name="conditions[form][shipment][shipment_weight_multiple_conds_envialia][configuration][form][condition_' . $i . '][enabled]"]' => ['checked' => FALSE],
          ],
          'required' => [
            ':input[name="conditions[form][shipment][shipment_weight_multiple_conds_envialia][configuration][form][condition_' . $i . '][enabled]"]' => ['checked' => TRUE],
          ],
        ],
      ];
