...
namespace Drupal\commerce_envialia\Plugin\Commerce\ShippingMethod;
 ...
 *   id = "envialia",
 *   label = @Translation("Envialia"),
 * )
 */
class envialia extends ShippingMethodBase {
  ...
  public function calculateRates(ShipmentInterface $shipment) {
    ...
    $extra_weight_rate = number_format($conf['extra_weight_rate']['number'], 3, '.', '');
